...
def main(path_folder=None):
    ...
    args["path_file_landuse_geojson"] = os.path.join(path_folder,
                                                     #"display",
                                                     "static","landuse.geojson") # TODO: can be taken uplevel,
    args["path_file_street_segment_geojson"] = os.path.join(path_folder,
                                                            #"display",
                                                            "static","street_segment.geojson") # TODO: can be taken uplevel,
